...
const CommentsField = () => {
    ...
    const [profile, setProfile] = useState(Comments[position.current])
    ...
    const pass = (event) => {
        ...
        setProfile(Comments[position.current])
    }
            ...
            <div className="comments__container">
                ...
                <article className="comments__card">
                    <div className="comments__img">
                        <img className="comments__img-profile" src={profile.img} alt="Foto do usuário" />
                    </div>
                    <h3 className="comments__name">{profile.name}</h3>
                    <p className="comments__review"> {profile.comment}</p>
